      ...
      <form id="form" v-on:submit.prevent="addUser" v-if="!enviado">
        <div class="um">
          ...
          <div>
            ...
            <select class="opcoes" name="aldeias" v-model="newUsers.residenceAgente">
        ...
        <div class="dois">
          ...
          <div class="casas">
            ...
            <input type="number" v-model="newUsers.casa1"/>
            <label for="casa2">Casa 2</label>
            <input type="number" v-model="newUsers.casa2"/>
          </div>
        </div>
        <div class="tres">
  ...
  methods: {
    ...
    addUser: function () {
      db.collection("agentes").add({
        ...
        casa1:`${this.newUsers.casa1}`,
        casa2:`${this.newUsers.casa2}`
      });
      this.enviado = true;
    },
  },
